"""Built-in tool for reading a whole local file or a portion of it."""
...
DESCRIPTION = (
    ...
    "fetch remote URLs; output is line-numbered text, so a blank window means the file or the "
...
def read_tool(fs: FileSystem) -> Tool:
    """Return a Read tool that serves file contents from the given filesystem."""
