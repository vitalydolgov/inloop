"""Built-in tool for writing a whole file to the local filesystem."""
...
DESCRIPTION = (
    ...
    "known contents. "
    "Always replaces the whole file — to change part of an existing file without rewriting it, prefer "
    "`patch`; it does not create missing parent directories."
)
